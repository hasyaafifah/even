        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd">Nomor Whatsapp</label>
                        <div class="col-sm-10">
                    ...
                    <?php if (is_array($queryAllMua)) { ?>
                        ...
                        <?php foreach ($queryAllMua as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url("/uploads/data_mua/$row->gambar") ?>" class="btn btn-sm btn-primary" download><i class="fa fa-cancel">Download</i></a>
